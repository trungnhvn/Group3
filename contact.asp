...
<html >
   ...
   <body>
      ...
      <section class="mbr-section article content12 cid-qQkNcuj6xz" id="content12-3">
         <div class="container">
            <div class="media-container-row">
               <div class="mbr-text counter-container col-12 col-md-8 mbr-fonts-style display-5">
                  <ul>
                     ...
                     <li><em>Email: thecoffee@gmail.com</em></li>
                     <li><em>SĐT: (+84)2383.123456</em></li>
                  </ul>
               </div>
            </div>
         </div>
               ...
               <div class="col-md-6">
                  ...
                  <div data-form-type="formoid">
                     ...
                     <form class="block mbr-form" action="#" method="post" data-form-title="Mobirise Form">
                        <input type="hidden" name="email" data-form-email="true" value="skB4DhyhNKG26yXTLWkzy60pUa8kxNGvL4XJwiPpIZXlxSSc9XLl3DzvYpu6ZUqZucglB0zkodai7rjNYiRfllmYm6NjuY0LuEiyj4YwrFSDk/YJ6CJ58reXDAisI7nm" data-form-field="Email">
                        <div class="row">
